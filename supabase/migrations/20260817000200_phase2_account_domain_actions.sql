...
comment on function public.phase2_complete_onboarding(uuid, text, public.sf6_rank, smallint, integer, text, text, text) is
...
revoke all on function private.phase2_lock_account(uuid) from public, anon, authenticated;
revoke all on function private.phase2_lock_match_participant_account() from public, anon, authenticated;
revoke all on function private.phase2_claim_user_code(text, uuid) from public, anon, authenticated;
revoke all on function private.phase2_release_live_user_code(text, uuid) from public, anon, authenticated;
...
revoke execute on function public.phase2_save_account_step(uuid, text, text, text, text, text, text, integer, integer, integer, text, public.avatar_source_type) from public, anon, authenticated;
...
revoke execute on function public.phase2_complete_onboarding(uuid, text, public.sf6_rank, smallint, integer, text, text, text) from public, anon, authenticated;
...
revoke execute on function public.phase2_release_deleted_user_code(uuid, text, text, text, text) from public, anon, authenticated;

grant execute on function public.phase2_onboarding_state(uuid) to service_role;
grant execute on function public.phase2_save_account_step(uuid, text, text, text, text, text, text, integer, integer, integer, text, public.avatar_source_type) to service_role;
...
grant execute on function public.phase2_complete_onboarding(uuid, text, public.sf6_rank, smallint, integer, text, text, text) to service_role;
...
grant execute on function public.phase2_release_deleted_user_code(uuid, text, text, text, text) to service_role;
